...
public class CommonOnPage implements WebElementAction{
	...
	//Etat_connecté
	@FindBy(xpath="//span[contains(text(), 'CONNECTÉ(E)']")
	public WebElement txt_connecté;
	
	/*
	 * //Etat_connecté
	@FindBy(xpath="//a/span[@class='label']")
	WebElement txt_connecté;
	 */

	//<span class="label">CONNECTÉ(E)</span>
	...
	public void isConnected(){		
		...
		Assert.assertEquals(txt_connecté.getText().toString().toLowerCase(), statut.toLowerCase());
	}
...
/*	
	...
	public void isConnected(){
		Assert.assertTrue(txt_connecté.isDisplayed());
	}
